...
class SyncBridgeState(Base):
    ...
    next_delivery_seq: Mapped[int] = mapped_column(Integer, default=1, nullable=False)
    last_acked_delivery_seq: Mapped[int | None] = mapped_column(Integer)
    last_failed_delivery_seq: Mapped[int | None] = mapped_column(Integer)
    last_seen_delivery_seq: Mapped[int | None] = mapped_column(Integer)
